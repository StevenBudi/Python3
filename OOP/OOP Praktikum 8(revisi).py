...
Data = Pegawai(123, "Steve", "sudah", 5)
print(Data.hitungGajiPokok(8, "a"))
print(Data.hitungTunjanganIstri())
print(Data.hitungTunjanganAnak())
print(Data.hitungGajiKotor())
print(Data.hitungPotongan())
print(Data.hitungGajiBersih())
Data.cetakStrukGaji()
